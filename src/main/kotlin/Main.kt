...
fun main(args: Array<String>) {
    // Menginstansiasi object reader dari class scanner
    ...
    // Mengubah isi string dalam variabel nama menjadi huruf kecil
    nama = nama.lowercase()

    /*
     * Input tanggal lahir dengan format ddmmyyyy.
     * Contoh: 06 Februari 2002, maka input 06022002
     */
    ...
    /*
     * Mengiterasi panjang dari nama secara mundur, serta
     * Memberikan kondisi (percabangan) sesuai ketentuan soal
     */
    ...
    while (j < tglLahir.length) {
        // Mengkonversi char menjadi string, kemudian mengkonversinya menjadi integer
